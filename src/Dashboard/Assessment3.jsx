...
function Assesment3() {
    ...
    const questions = [
        ...
        {
            question: "How do you feel about working with vulnerable populations (children, elderly, sick)?",
            options: [
        ...
        {
            question: "How important is it for you to see direct impact of your work on others?",
            options: [
